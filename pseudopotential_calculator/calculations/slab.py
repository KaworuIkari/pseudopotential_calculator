...
# a = read('/Users/min/desktop/Cu/E_cut/E_cut_600/Cu_cell.geom', format = 'castep-geom')
a = read("/Users/tychus/summer_project/Cu.cell", format="castep-cell")

# a = read('/Users/min/desktop/save7.poscar', format = 'vasp')
b = surface(a, (0, 0, 1), 6, vacuum=3)
